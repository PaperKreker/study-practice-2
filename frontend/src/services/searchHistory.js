 ...
 *
 * Используется для неавторизованных пользователей: их история сохраняется
 * локально в браузере. Для авторизованных пользователей история ведётся на
 * сервере (см. fetchSearchHistory / clearSearchHistory в services/api.js).
 */
